...
start "test3" cmd /k "cd .. && .\bin\program.exe test3 && .\scripts\util\compare experiments\test3output\K45\results\finalresults0.txt experiments\current_results.txt"
start "test4" cmd /k "cd .. && .\bin\program.exe test4 && .\scripts\util\compare experiments\test4output\K45\results\finalresults0.txt experiments\current_results.txt"