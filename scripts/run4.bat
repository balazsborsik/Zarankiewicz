...
REM copy ..\output\%test1_KST%\graphs\* ..\experiments\test1output\%test1_KST%\graphs\
copy ..\output\%test2_KST%\graphs\* ..\experiments\test2output\%test2_KST%\graphs\
REM copy ..\output\%test3_KST%\graphs\* ..\experiments\test3output\%test3_KST%\graphs\
copy ..\output\%test4_KST%\graphs\* ..\experiments\test4output\%test4_KST%\graphs\

 REM ..\scripts\util\shuffle_graphs.exe ..\experiments\test1output\%test1_KST%\graphs
 ..\scripts\util\shuffle_graphs.exe ..\experiments\test2output\%test2_KST%\graphs
 REM ..\scripts\util\shuffle_graphs.exe ..\experiments\test3output\%test3_KST%\graphs
