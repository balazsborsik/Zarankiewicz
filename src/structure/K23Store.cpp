...
K23Store::K23Store() : edges_in_circles_(Constants::MAX_SIZE, Constants::MAX_SIZE) {}
...
void K23Store::storeKst(const Graph& adj, int u, int v)
{
...
void K23Store::reevalCircles(const Graph& adj)
{
  KstHelper::reevalCircles<S_, T_>(circles_, edges_in_circles_, adj);
}

bool K23Store::reflipCircle(Graph& adj, Probabilities& prob)
{
